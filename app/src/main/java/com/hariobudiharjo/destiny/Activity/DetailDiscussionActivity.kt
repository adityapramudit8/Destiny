...
import com.hariobudiharjo.destiny.Fragment.CommentDiscussionFragment
import com.hariobudiharjo.destiny.Fragment.OverviewDiscussionFragment
...
//        bundleTeam.putString("idteam", idTeam)
        ...
        adapter.addFragment(OverviewDiscussionFragment(), "Overview")
        adapter.addFragment(CommentDiscussionFragment(), "Comment")
