...
class CoursesAdapter(private val context: Context, private val items: List<coursesModel>) :
    RecyclerView.Adapter<CoursesAdapter.ViewHolder>() {
    class ViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        fun bindItems(data: coursesModel) {
...
//            image.setImageResource(data.imageint!!)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CoursesAdapter.ViewHolder {
        val view = LayoutInflater.from(context)
            .inflate(R.layout.rv_list_courses_item_row, parent, false)
